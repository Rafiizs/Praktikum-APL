...
void sortmangabyjudul(Manga mangalist[], int jumlahmanga);
void sortmangabyharga(Manga mangalist[], int jumlahmanga);
void sortkeranjangtotalharga(Keranjang keranjang [], int jumlahkeranjang);
...
void sortmangabyjudul(Manga mangalist[], int jumlahmanga) {
    sort(mangalist, mangalist + jumlahmanga, [] (Manga a, Manga b) {
...
void sortkeranjangtotalharga(Keranjang keranjang[], int jumlahKeranjang) {
    sort(keranjang, keranjang + jumlahKeranjang, [] (Keranjang a, Keranjang b) {
                ...
                if (username == userakun.username && password == userakun.password) {
                    while (true) {
                        ...
                        if (pilihan == 1) {
                            ...
                            cout << "\n========================================";
                            cout << "\n1. Tampilkan biasa";
                            cout << "\n2. Urutkan berdasakan judul (A-Z)";
                            cout << "\n3. Urutkan berdasarkan harga (terendah ke tertinggi)";
                            cout << "\nPilihan:";
                            cin >> sortpilihan;
                            cin.ignore();

                            if (sortpilihan == 2) {
                                sortmangabyjudul(mangaList, jumlahmanga);     
                            } else if (sortpilihan == 3) {
                                sortmangabyharga(mangaList, jumlahmanga);
                            }
                            tampilkanDaftarManga(mangaList, jumlahmanga);
                        } else if (pilihan == 2) {
                            tambahKeKeranjang(keranjang, jumlahKeranjang, mangaList, jumlahmanga);
                        } else if (pilihan == 3) {
                            int sortkeranjangapilihan;
                            cout << "\n========================================";
                            cout << "\n        LIHAT KERANJANG";
                            cout << "\n1. Tampilkan biasa";
                            cout << "\n2. Urutkan berdasarkan total harga (terendah ke tertinggi)";
                            cout << "\nPilihan: ";
                            cin >> sortkeranjangapilihan;
                            cin.ignore();

                            if (sortkeranjangapilihan == 2) {
                                sortkeranjangtotalharga(keranjang, jumlahKeranjang);
                            }
                            tampilkanKeranjang(keranjang, jumlahKeranjang);
                        } else if (pilihan == 4) {
